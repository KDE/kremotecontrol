...
int main( int argc, char **argv ) {
    ...
    KAboutData aboutData("krcdnotifieritem", 0, ki18n("Remote Control"), "kdeutils version goes here" /*KDEUTILS_VERSION_STRING*/, ki18n("The KDE Infrared Remote Control Server"), KAboutData::License_GPL, ki18n("(c) 2010 Michael Zanetti, (c) 2010 Frank Scheffold"), ki18n("Control your desktop with your remote."), "http://utils.kde.org/projects/kdelirc");
