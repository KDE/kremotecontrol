...
#include <kdelirc/libkremotecontrol/profileserver.h>
#include <kdelirc/libkremotecontrol/modeswitchaction.h>
#include <kdelirc/libkremotecontrol/profileaction.h>
...
#include <kdelirc/libkremotecontrol/newprofileserver.h>
...
//  argumentList.append(argument);
  ...
  foreach(const ProfileActionTemplate &tmp, NewProfileServer::actionTemplateList(remote, profile)){
    kDebug() << "ActionTemplate " << tmp.actionTemplateID() << "matches";
